...
const HeroSection = () => {
    return (
        <div className="w-full flex items-center justify-between px-20 my-20">
            <div className="w-1/2 ms-20">
                ...
                <Button className='bg-[#808080] hover:bg-black text-black hover:text-white rounded-full py-4 mb-20 w-[160px]' colorScheme='twitter'>
                    <span className='tracking-wider secondary-font'>Contact Me</span>
                </Button>
            </div>
            <div className="w-1/2">
                <img className="w-[300px] h-[300px] rounded-full object-cover animate-float mx-auto me-20" src="https://i.ibb.co/SBsKyjD/left.jpg" alt="" />
            </div>
        </div>
    );
};
